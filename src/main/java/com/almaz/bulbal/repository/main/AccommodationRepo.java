...
public interface AccommodationRepo extends JpaRepository<Accommodation, Long> {
    ...
    Page<MainPageDto> searchAccommodationsByLocality(PageRequest pageRequest, @Param(value = "checkInDateTime") LocalDateTime checkInDateTime, @Param(value = "checkOutDateTime") LocalDateTime checkOutDateTime, @Param(value = "locality") String locality, @Param(value = "capacity") Long capacity);
    ...
    @Query(value = "SELECT x.id, x.region, x.locality_name as localityName, x.title_of_accommodation as titleOfAccommodation, x.price as price, i.file_name as imageFullName, " +
            ...
            "and x.status = 'Опубликовано' " +
            "order by x.create_date desc", nativeQuery = true)
    Page<MainPageDto> searchAccommodationsByRegion(PageRequest pageRequest, @Param(value = "checkInDateTime") LocalDateTime checkInDateTime, @Param(value = "checkOutDateTime") LocalDateTime checkOutDateTime, @Param(value = "region") String region, @Param(value = "capacity") Long capacity);
    ...
    Page<MainPageDto> searchBedsByLocality(PageRequest pageRequest, @Param(value = "checkInDateTime") LocalDateTime checkInDateTime, @Param(value = "checkOutDateTime") LocalDateTime checkOutDateTime, @Param(value = "locality") String locality, @Param(value = "capacity") Long capacity);
    ...
    @Query(value = "SELECT b.id AS id, r.region, r.locality_name as localityName, r.title_of_accommodation as titleOfAccommodation, r.price_per_bed as price, i.file_name as imageFullName, r.create_date as createDate " +
            ...
            "and i.main = true " +
            "order by r.create_date desc", nativeQuery = true)
    Page<MainPageDto> searchBedsByRegion(PageRequest pageRequest, @Param(value = "checkInDateTime") LocalDateTime checkInDateTime, @Param(value = "checkOutDateTime") LocalDateTime checkOutDateTime, @Param(value = "region") String region, @Param(value = "capacity") Long capacity);
